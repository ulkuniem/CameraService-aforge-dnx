...
namespace CameraService.DPP
{
    ...
    public class TemplateMessage
    {
        ...
        // Errors appear in result and nosub messages in an optional error field.
        ...
        // added, changed 
        public string fields { get; set; } // optional object with EJSON values

        // changed
        public string[] cleared { get; set; } // optional array of strings (field names to delete)

        // ready (server -> client):
        public string[] subs { get; set; } // array of strings (ids passed to 'sub' which have sent their initial batch of data)

        // msg: addedBefore (server -> client):
        public string before { get; set; } // string or null (the document ID to add the document before, or null to add at the end)
        ...
        public TemplateMessage(string msg)
        {
            ...
            {
                version = "pre1";
                support = new string[] { "pre1", };
            }
        }

        public TemplateMessage(TemplateMessage other)
        {
            if (other != null)
            {
                this.id = other.id;
                ...
                this.offendingMessage = other.offendingMessage;
        ...
        public string stringify()
        {
            ...
            {
                Console.WriteLine("Error stringify: " + e);
            }
            return null;
        }
